...
const ReliefFunds = () => {
  localStorage.setItem("category", "ReliefFunds");
  ...
  return (
    <>
      <WithPermission roleRequired="MEMBER" message="Only Member can view this">
        ...
        <h1 className="head1">Relief Funds</h1>
              ...
              .map((fund) => (
                <div className="container3">
                  <div className="container2">
                    ...
                    <Link
                      to={{ pathname: `/user/manage`, state: fund.id }}
                      className="btn1 right"
                    >
                      <span
                        onClick={() => {
